                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="#" method="POST" id="register_form">
                            ...
                            <div class="mb-3">
                                ...
                                rounded-0" placeholder="full name">
                            ...
                            <div class="mb-3">
                                ...
                                rounded-0" placeholder="password">
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                rounded-0" placeholder="confirm password">
                                <div class="invalid-feedback">
                            ...
                            <div class="text-center text-secondary">
                                <div>Already have an account? <a href="/" class="text-decoration-none">
                                    Login Here</a></div>
                            </div>
                        </form>
                    </div>
